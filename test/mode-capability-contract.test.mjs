...
test("page extraction and rendering remain shared and backend-agnostic", async () => {
  ...
  for (const required of [
    "src/extractors/cnki.js", "src/extractors/scopus.js", "src/extractors/web-of-science.js", "src/extractors/generic.js", "src/extractors/runner.js",
    "src/adapters/cnki.js", "src/adapters/scopus.js", "src/adapters/web-of-science.js", "src/adapters/sciencedirect.js",
    "src/content.js"
  ]) assert.equal(scripts.filter((value) => value === required).length, 1, required);

  for (const name of [
    "extractors/cnki.js", "extractors/scopus.js", "extractors/web-of-science.js", "extractors/generic.js", "extractors/runner.js",
    "adapters/cnki.js", "adapters/scopus.js", "adapters/web-of-science.js", "adapters/sciencedirect.js", "content.js"
  ]) {
