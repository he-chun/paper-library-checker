...
test("published manifest points to v0.5.0 while preserving v0.3.0 qualification evidence", async () => {
  ...
  assert.equal(item.update_link, "https://github.com/he-chun/paper-library-checker/releases/download/v0.5.0/paper-library-checker-zotero-0.5.0.xpi");
  assert.equal(item.update_hash, "sha256:243e6e873f30537a7f6a8b7ec538b124f6484c67c6824c05e6edb587495253ea");
  assert.equal(createHash("sha256").update(published).digest("hex"), "c9bd7accc7094e6ce7332354a454ae6943d08930ac739345b39436295bb82084");
