(function (root, factory) {
  ...
  const EN_MESSAGES = Object.freeze({
    ...
    visualCuesHeading: "Visual cues",
    searchResultHighlightingHeading: "Search results",
    highlightSearchResultRows: "Highlight saved and possibly saved search-result rows",
    searchResultMatchedBackground: "Saved row color",
    searchResultPossibleBackground: "Possibly saved row color",
    pageEdgeHeading: "Page edge",
    enablePageGlow: "Enable a colored page edge based on the check result",
    pageEdgeStyleLabel: "Edge style",
    pageEdgeStyleGlow: "Glow",
    pageEdgeStyleSolid: "Solid",
    pageEdgeStyleDashed: "Dashed",
    pageEdgeStyleDotted: "Dotted",
    pageEdgeStyleDouble: "Double",
    pageEdgeWidthLabel: "Edge width",
    pageEdgeColorsHeading: "Page edge colors",
    pageEdgeMatchedColor: "Saved",
    pageEdgePossibleColor: "Possible match",
    pageEdgeMissingColor: "Not saved",
    pageEdgeUnknownColor: "Unknown",
    pageEdgeErrorColor: "Error",
    resetVisualPreferences: "Restore default visual settings",
    visualPreferencesReset: "Default visual settings restored.",
