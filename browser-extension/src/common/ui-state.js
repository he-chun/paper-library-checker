(function (root, factory) {
  ...
  const PAGE_STATES = Object.freeze({
    ...
    NOT_SAVED: "not_saved",
    INCOMPLETE_NOT_FOUND: "incomplete_not_found",
  ...
  const PAGE_MESSAGE_KEYS = Object.freeze({
    ...
    [PAGE_STATES.INCOMPLETE_NOT_FOUND]: "pageIncompleteNotFound",
    [PAGE_STATES.STALE_MATCH]: "pageStaleMatch",
    [PAGE_STATES.STALE_UNKNOWN]: "pageStaleUnknown",
